# libStorage [![GoDoc](https://godoc.org/github.com/emccode/libstorage?status.svg)](http://godoc.org/github.com/emccode/libstorage) [![Build Status](http://travis-ci.org/emccode/libstorage.svg?branch=master)](https://travis-ci.org/emccode/libstorage) [![Go Report Card](http://goreportcard.com/badge/emccode/libstorage)](http://goreportcard.com/report/emccode/libstorage) [![Coverage Status](http://coveralls.io/repos/emccode/libstorage/badge.svg?branch=master&service=github)](https://coveralls.io/github/emccode/libstorage?branch=master)
