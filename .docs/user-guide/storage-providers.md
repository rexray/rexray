...
[read the provision](./libstorage.md#clientserver-configuration) about
...
[transformed](./libstorage.md#configuration-properties).
...
[activating storage drivers](./libstorage.md#storage-drivers),
...
[activating storage drivers](./libstorage.md#storage-drivers), using `rbd` as the
driver name.
...
[activating storage drivers](./libstorage.md#storage-drivers), using `gcepd` as the
driver name.
...
[activating storage drivers](./libstorage.md#storage-drivers), using `azureud` as
the driver name.
